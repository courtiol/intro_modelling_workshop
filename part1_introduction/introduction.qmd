...
::: {.incremental}
- Many local actors collect invaluable data on biodiversity in one of the most biodiversity-rich regions in the world
...
- maintainer and co-developer of R packages (e.g. camtrapR, IsoriX...)
...
$\rightarrow$ [github.com/courtiol/intro_modelling_workshop](https://github.com/courtiol/intro_modelling_workshop)
