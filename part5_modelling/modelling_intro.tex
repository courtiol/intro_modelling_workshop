...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit\_alien\_glm, }\AttributeTok{newdata =} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{humans\_eaten =} \DecValTok{1}\NormalTok{), }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{p2 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit\_alien\_glm, }\AttributeTok{newdata =} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{humans\_eaten =} \DecValTok{2}\NormalTok{), }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{p5 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit\_alien\_glm, }\AttributeTok{newdata =} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{humans\_eaten =} \DecValTok{5}\NormalTok{), }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
\NormalTok{p6 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit\_alien\_glm, }\AttributeTok{newdata =} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{humans\_eaten =} \DecValTok{6}\NormalTok{), }\AttributeTok{type =} \StringTok{"response"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p6 }\SpecialCharTok{{-}}\NormalTok{ p5}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{GLM --- predictions and interpretation}
\protect\phantomsection\label{glm-predictions-and-interpretation-4}
Demonstration about exponential of estimates as odds ratio
...
\NormalTok{(p2}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ p2)) }\SpecialCharTok{/}\NormalTok{ (p1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ p1)) }\CommentTok{\# odds ratio for 2 humans eaten compared to 1 eaten}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(p6}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ p6)) }\SpecialCharTok{/}\NormalTok{ (p5}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ p5)) }\CommentTok{\# odds ratio for 6 humans eaten compared to 5 eaten}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{GLM --- predictions and interpretation}
\protect\phantomsection\label{glm-predictions-and-interpretation-5}
Demonstration about exponential of estimates as odds ratio
...
\FunctionTok{exp}\NormalTok{(}\FunctionTok{coef}\NormalTok{(fit\_alien\_glm)[}\StringTok{"humans\_eaten"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\begin{frame}[fragile]{GLM --- predictions and interpretation}
\protect\phantomsection\label{glm-predictions-and-interpretation-6}
At the scale of the response variable, predictions and interpretation
differ
...
\begin{itemize}
\item
  on average, every additional meter in median elevation changes the
  number of territories by \(100 \times (e^{\text{slope}}-1)=\)
  -0.0432\blueit{\%}
\item
  on average, every additional 1000 meters in median elevation increases
...
\begin{center}
\includegraphics[width=\linewidth,height=6cm,keepaspectratio]{modelling_intro_files/figure-beamer/unnamed-chunk-38-1.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\linewidth,height=4cm,keepaspectratio]{modelling_intro_files/figure-beamer/unnamed-chunk-40-1.pdf}
\end{center}
...
\begin{itemize}
\item
  \blueit{negative binomial model} (e.g.~\{spaMM\}, \{glmmTMB\},
  \{brms\}, \{nimble\})
\item
  ...
  \end{itemize}
\item
  negative binomial zero-augmented models (e.g.~\{glmmTMB\}, \{brms\},
  \{nimble\})
\end{itemize}
\end{frame}
