...
(the denominators of $\mathrm{posterior}(\theta')$ and $\mathrm{posterior}(\theta)$ are identical and cancel out in the ratio)
...
Let's use the Metropolis algorithm to estimate the mean and SD of petal length of\\ \emph{Iris versicolor}
...
# Developer corner {.unnumbered .unlisted}
